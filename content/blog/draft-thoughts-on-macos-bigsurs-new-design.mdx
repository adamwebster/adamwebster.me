...
Everything in macOS Big Sur is a little bit brighter, for example the gray gradient application headers have mostly been replaced with a white application header.
