...
<svg width={width} class={classNames} height="100%" viewBox="0 0 30 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
    <g transform="matrix(1,0,0,1,-1855.73,-13.6115)">
        <g transform="matrix(1,0,0,2.20208,1667.25,9.61153)">
            <g id="Artboard4" transform="matrix(0.135956,0,0,0.0617399,188.484,1.8164)">
